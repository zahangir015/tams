...
$this->title = Yii::t('app', 'Bank Ledgers');
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => kartik\select2\Select2::widget(WidgetHelper::ajaxSelect2Widget('BankLedgerSearch[refId]', '/account/bank-account/get-banks', false, 'refId', 'refId'))
            ],
            [
                'attribute' => 'reference',
            ],
        ...
        'toolbar' => [
            [
                'content' =>
                    Html::a('<i class="fas fa-redo"></i>', ['/account/ledger/bank-ledger'], [
