...
$this->title = Yii::t('app', 'Supplier Advance Payments');
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => \kartik\select2\Select2::widget(WidgetHelper::ajaxSelect2Widget('SupplierAdvancePaymentSearch[refId]', '/sale/supplier/get-suppliers', false, 'refId', 'refId'))
            ],
            'bankId',
            'paidAmount',
            'remarks:ntext',
        ...
        'toolbar' => [
            [
                'content' =>
                    ...
                    Html::a('<i class="fas fa-redo"></i>', ['/account/advance-payment/supplier-advance-payment'], [
