    ...
    <?php $form = ActiveForm::begin(); ?>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md">
                        <?= $form->field($transaction, 'bankId')->widget(Select2::class, Helper::ajaxDropDown('bankId', '/account/bank-account/get-bankList', 'true', 'bankId', 'bankId'))->label('Bank');
                        ?>
                    </div>
                    <div class="col-md">
                    ...
                    <div class="col-md">
                        <?= $form->field($transaction, 'paidAmount')->textInput(['value' => ($model->totalCost - $model->totalPaid), 'max' => ($model->totalCost - $model->totalPaid), 'min' => 1]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
