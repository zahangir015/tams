...
class LeaveApprovalPolicyController extends ParentController
{
    ...
    /**
     * Finds the LeaveApprovalPolicy model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return LeaveApprovalPolicy the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LeaveApprovalPolicy::findOne(['id' => $id])) !== null) {
            return $model;
        }
