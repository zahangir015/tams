    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md">
                    <?= $form->field($model, 'shiftId')->widget(Select2::class, Utilities::ajaxDropDown('shiftId', '/hrm/shift/get-shifts', true, 'shiftId', 'shiftId', $model->isNewRecord ? [] : [$model->shift->id => $model->shift->title])) ?>
                </div>
            </div>
