                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <input name="" class="form-control"
                                           value="<?= HrmConstant::PAYROLL_CATEGORY[$item['category']] ?>"
                                           readonly="readonly">
                                </div>
                                <div class="col-md">
                                    <label class="control-label">
                                    ...
                                    <input name="" class="form-control"
                                           value="<?= HrmConstant::CALCULATING_METHOD[$item['calculatingMethod']] ?>"
                                           readonly="readonly">
                                </div>
                                <div class="col-md">
                                    <label class="control-label">
                                    ...
                                    <input name="" class="form-control"
                                           value="<?= HrmConstant::AMOUNT_TYPE[$item['amountType']] ?>"
                                           readonly="readonly">
                                </div>
                                <div class="col-md">
                                    <label class="control-label">
                                    ...
                                    <input name="" class="form-control" value="<?= $item['amount'] ?>"
                                           readonly="readonly">
                                </div>
                                <div class="col-md">
