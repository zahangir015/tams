    ...
    <div class="card card-custom mb-5 sticky-top">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md">
                    <?= $form->field($model, 'customerId')->dropdownList([$model->customer->id => $model->customer->company], ['readOnly' => 'readOnly'])->label('Customer') ?>
                </div>
                <div class="col-md">
                    <?= $form->field($model, 'holidayCategoryId')->dropdownList($holidayCategories, ['prompt' => '', 'readOnly' => 'readOnly', 'value' => $model->holidayCategoryId])->label('Category') ?>
                </div>
                <div class="col-md">
                    <?= $form->field($model, 'issueDate')->textInput(['value' => $model->issueDate, 'readOnly' => 'readOnly']) ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-5 col-lg-4 order-md-last">
            <div class="card card-custom card-border mb-7">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md">
                            <?= $form->field($model, 'identificationNumber')->textInput(['value' => Utilities::holidayIdentificationNumber(), 'readOnly' => 'readOnly']) ?>
                        </div>
                        <div class="col-md">
                            <?= $form->field($model, 'route')->textInput(['maxlength' => true, 'readOnly' => 'readOnly', 'value' => $model->route]) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md">
                        ...
                        <div class="col-md">
                            <?= $form->field($holidayRefund, 'supplierRefundCharge')->textInput(['type' => 'number', 'value' => $holidayRefund->isNewRecord ? 0 : $holidayRefund->supplierRefundCharge, 'min' => 0, 'step' => 'any']) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?= $form->field($model, 'motherId')->hiddenInput(['value' => $model->id])->label(false) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md">
