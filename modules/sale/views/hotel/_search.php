...
/* @var $model app\modules\sale\models\hotel\HotelSearch */
...
<div class="hotel-search">
    ...
    <?php // echo $form->field($model, 'reservationCode') ?>
    ...
    <?php // echo $form->field($model, 'freeCancellationDate') ?>

    <?php // echo $form->field($model, 'totalNights') ?>

    <?php // echo $form->field($model, 'route') ?>

    <?php // echo $form->field($model, 'isRefundable') ?>
