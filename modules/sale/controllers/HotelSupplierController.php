 ...
 */
class HotelSupplierController extends ParentController
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single HotelSupplier model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new HotelSupplier model.
    ...
    /**
     * Updates an existing HotelSupplier model.
    ...
    /**
     * Deletes an existing HotelSupplier model.
    ...
    {
        if (($model = HotelSupplier::findOne(['id' => $id])) !== null) {
            return $model;
        }
